        ...
        <section ref={comp} className="relative h-[75dvh] md:h-[100dvh] w-full flex items-end pb-12 md:pb-[296px] px-6 md:px-16 overflow-hidden">
            ...
            <div className="relative z-10 max-w-7xl w-full flex flex-col items-start gap-6">
                <h1 className="flex flex-col gap-2">
                    ...
                    <span className="hero-text font-drama font-black italic text-accent text-7xl md:text-[5.5rem] lg:text-[9rem] leading-[0.8] md:whitespace-nowrap normal-case tracking-tighter">
